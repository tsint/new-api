...
func InitEnv() {
	...
	DataExportUserRankingLimit = GetEnvOrDefault("DATA_EXPORT_USER_RANKING_LIMIT", DataExportUserRankingLimit)
	if DataExportUserRankingLimit < 1 {
		DataExportUserRankingLimit = 1
	}
